...
EOF
  # Not self-hosted, runs on ubuntu-latest for both style and build
  include 0 ubuntu-latest == "" ubuntu-latest
}
...
EOF
  # Self-hosted, runs on bors for both style and build
  include 1 bors == "" bors
}
...
bors_yml > ../.github/workflows/bors.yml
build_fork_yml > ../.github/workflows/build_fork.yml
