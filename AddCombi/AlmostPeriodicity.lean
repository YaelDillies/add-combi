...
-- public import AddCombi.Prereqs.Function.Indicator.Defs
-- public import AddCombi.Prereqs.LpNorm.Discrete.Defs

-- import AddCombi.Convolution.Finite.Discrete.Basic
-- import AddCombi.Convolution.Finite.Norm
-- import AddCombi.Prereqs.Inner.Hoelder.Discrete
-- import AddCombi.Prereqs.LpNorm.Discrete.Basic
import AddCombi.Concentration.MarcinkiewiczZygmund
...
theorem linfty_almost_periodicity (ε : ℝ) (hε₀ : 0 < ε) (hε₁ : ε ≤ 1) (hK₂ : 2 ≤ K)
  ...
  calc
    ...
    _ ≤ ε / exp 1 * #B ^ (M : ℝ)⁻¹ * ‖μ_[ℂ] (x +ᵥ -C)‖_[NNReal.conjExponent M] := by
        gcongr
        simpa only [← ENNReal.coe_natCast, MeasureTheory.dLpNorm_indicator hM₀] using hT _ ht
